...
export async function sendMail(opts: MailOpts): Promise<{ ok: boolean; error?: string }> {
  ...
  const from = process.env.DEFAULT_FROM_EMAIL || "no-reply@Maitri.gov";
  try {
    await sgMail.send({
      from,
      to: opts.to,
...
<html><body style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;background:#0c1220;padding:24px;color:#e7ecf3">
  <div style="max-width:560px;margin:0 auto;background:#131a2c;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:32px">
    <h1 style="color:#00e5ff;margin:0 0 8px;font-size:22px;">Maitri — Station Approved</h1>
    <p style="color:#8a93a6;margin:0 0 20px;font-size:13px;">Your registration has been approved by Maitri operations.</p>
    ...
    <p style="color:#8a93a6;font-size:12px">
      Please change your password on first login. This credential is unique to your station and grants access to the Maitri command center.
    </p>
    ...
    <p style="color:#666;font-size:11px;margin-top:32px">Maitri Operations · government-grade emergency response</p>
  </div>
</body></html>
  `;
}
...
<html><body style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;background:#0c1220;padding:24px;color:#e7ecf3">
  <div style="max-width:560px;margin:0 auto;background:#131a2c;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:32px">
    <h1 style="color:#00e5ff;margin:0 0 8px;font-size:22px;">Maitri — Officer Onboarded</h1>
